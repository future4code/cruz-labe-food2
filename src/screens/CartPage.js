...
const CartPage = () => {
    ...
    const onClickConfim = () =>{
        ...
        placeOrder(products, paymentMethod, restaurantDetail.id, setCart, setRestaurantDetail, setSnack, setLoading)
    }
    return (
            <div>
                <ComponentCart onClickConfim={onClickConfim} onChangePaymentMethod={onChangePaymentMethod} paymentMethod={paymentMethod} loading={loading}/>
