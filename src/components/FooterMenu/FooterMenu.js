...
const FooterMenu = ({currentPage}) => {
    ...
    return (
        <MainFooter>   
            <IconButton>
                <IconImage src={currentPage === "Home"?homepageRed: homepage } alt='home' onClick={() => goToHome(history)}/>
            </IconButton>

            <IconButton> 
                <IconImage  src={currentPage === "Cart"?shoppingCartRed: shoppingCart } alt='cart' onClick={() => goToCart(history)}/>
            </IconButton>

            <IconButton> 
                <IconImage src={currentPage === "Profile"? avatarRed: avatar } alt='avatar' onClick={() => goToProfile(history)}/>
            </IconButton>
        </MainFooter>
    );
}
